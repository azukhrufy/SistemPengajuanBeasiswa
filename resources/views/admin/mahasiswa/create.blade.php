            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.mahasiswa.store') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="nim" type="number" min="0" class="form-control{{ $errors->has('nim') ? ' is-invalid' : '' }}" name="nim" value="{{ old('nim') }}" required autofocus>
                            @if ($errors->has('nim'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="semester" type="number" min="0" max="8" class="form-control{{ $errors->has('semester') ? ' is-invalid' : '' }}" name="semester" value="{{ old('semester') }}" required autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="ipk" type="number" min="0" max="4" step="0.01" class="form-control{{ $errors->has('ipk') ? ' is-invalid' : '' }}" name="ipk" value="{{ old('ipk') }}" required autofocus>
                            @if ($errors->has('ipk'))
                            <span class="invalid-feedback" role="alert">
